 ...
 */
public class ASTLogBinaryExp<E extends ASTExp<E>> extends ASTExp<E> {
    
    String operator;
    ASTExp<E> exp1;
    ASTExp<E> exp2;

    public ASTLogBinaryExp(String operator, ASTExp<E> exp1, ASTExp<E> exp2) {
    ...
    public <S, T> T visit(ASTVisitor<E, S, T> v, S state) throws HPLException {
        return v.visitLogBinaryExp(this, state);
    }
}
